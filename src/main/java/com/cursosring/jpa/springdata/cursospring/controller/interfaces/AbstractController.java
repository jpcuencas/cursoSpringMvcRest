package com.cursosring.jpa.springdata.cursospring.controller.interfaces;
...
public class AbstractController  <E extends BillingEntity, DTO extends BillingDTO, ID extends Serializable> { {
    @Autowired
